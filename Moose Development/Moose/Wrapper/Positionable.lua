...
do -- Cargo
  ...
  POSITIONABLE.CargoBayCapacityValues = {
    ...
    ["Ground"] = {
      ...
      ["Blitz_36-6700A"] = 10*POSITIONABLE.DefaultInfantryWeight, -- new by kappa
      ["BMD-1"] = 9*POSITIONABLE.DefaultInfantryWeight, -- IRL should be 4 passengers
      ["BMP-1"] = 8*POSITIONABLE.DefaultInfantryWeight,
      ["BMP-2"] = 7*POSITIONABLE.DefaultInfantryWeight,
      ["BMP-3"] = 8*POSITIONABLE.DefaultInfantryWeight, -- IRL should be 7+2 passengers
      ["Boman"] = 25*POSITIONABLE.DefaultInfantryWeight,
      ["BTR-80"] = 9*POSITIONABLE.DefaultInfantryWeight, -- IRL should be 7 passengers
      ["BTR-82A"] = 9*POSITIONABLE.DefaultInfantryWeight, -- new by kappa -- IRL should be 7 passengers
      ...
      ["LAV-25"] = 6*POSITIONABLE.DefaultInfantryWeight,
      ["M-2 Bradley"] = 6*POSITIONABLE.DefaultInfantryWeight,
      ["M1043 HMMWV Armament"] = 4*POSITIONABLE.DefaultInfantryWeight,
      ["M1045 HMMWV TOW"] = 4*POSITIONABLE.DefaultInfantryWeight,
      ["M1126 Stryker ICV"] = 9*POSITIONABLE.DefaultInfantryWeight,
      ["M1134 Stryker ATGM"] = 9*POSITIONABLE.DefaultInfantryWeight,
      ["M2A1_halftrack"] = 9*POSITIONABLE.DefaultInfantryWeight,
      ["M-113"] = 9*POSITIONABLE.DefaultInfantryWeight, -- IRL should be 11 passengers
      ["Marder"] = 6*POSITIONABLE.DefaultInfantryWeight,
      ["MCV-80"] = 9*POSITIONABLE.DefaultInfantryWeight, -- IRL should be 7 passengers
      ["MLRS FDDM"] = 4*POSITIONABLE.DefaultInfantryWeight,
      ["MTLB"] = 25*POSITIONABLE.DefaultInfantryWeight, -- IRL should be 11 passengers
      ["GAZ-66"] = 8*POSITIONABLE.DefaultInfantryWeight,
      ["GAZ-3307"] = 12*POSITIONABLE.DefaultInfantryWeight,
      ["GAZ-3308"] = 14*POSITIONABLE.DefaultInfantryWeight,
      ["Grad_FDDM"] = 6*POSITIONABLE.DefaultInfantryWeight, -- new by kappa
      ["KAMAZ Truck"] = 12*POSITIONABLE.DefaultInfantryWeight,
      ["KrAZ6322"] = 12*POSITIONABLE.DefaultInfantryWeight,
      ["M 818"] = 12*POSITIONABLE.DefaultInfantryWeight,
      ["Tigr_233036"] = 6*POSITIONABLE.DefaultInfantryWeight,
      ["TPZ"] = 10*POSITIONABLE.DefaultInfantryWeight, -- Fuchs
      ["UAZ-469"] = 4*POSITIONABLE.DefaultInfantryWeight, -- new by kappa
      ["Ural-375"] = 12*POSITIONABLE.DefaultInfantryWeight,
      ["Ural-4320-31"] = 14*POSITIONABLE.DefaultInfantryWeight,
      ["Ural-4320 APA-5D"] = 10*POSITIONABLE.DefaultInfantryWeight,
      ["Ural-4320T"] = 14*POSITIONABLE.DefaultInfantryWeight,
